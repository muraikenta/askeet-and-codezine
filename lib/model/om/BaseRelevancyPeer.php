...
abstract class BaseRelevancyPeer {
	...
	const ANSWER_ID = 'relevancy.ANSWER_ID';

	
	const USER_ID = 'relevancy.USER_ID';

	
	const SCORE = 'relevancy.SCORE';

	
	const CREATED_AT = 'relevancy.CREATED_AT';
	...
	const COUNT = 'COUNT(relevancy.ANSWER_ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT relevancy.ANSWER_ID)';
